...
namespace Hangfire
{
    ...
    public partial class BackgroundJob
    {
            ...
            [CanBeNull] IDictionary<string, object> parameters = null)
        {
            ...
            return client.Enqueue(methodCall, parameters);
        }
        ...
        {
            var client = ClientFactory();
            return client.Schedule(methodCall, delay, parameters);
        }
        ...
        {
            var client = ClientFactory();
            return client.Schedule(methodCall, enqueueAt, parameters);
        }
        ...
        {
            var client = ClientFactory();
            return client.ContinueJobWith(parentId, methodCall, parameters);
        }
        ...
        {
            var client = ClientFactory();
            return client.ContinueJobWith(parentId, methodCall, options, parameters);
        }
